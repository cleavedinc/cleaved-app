...
export type Scalars = {
  ...
  PercentComplete: { input: any; output: any; }
...
export type Mutation = {
  ...
  projectSetPercentComplete?: Maybe<Scalars['Void']['output']>;
...
export type MutationProjectSetPercentCompleteArgs = {
  organizationId: Scalars['ID']['input'];
  percentComplete: Scalars['PercentComplete']['input'];
  projectId: Scalars['ID']['input'];
};
...
export type Project = {
  ...
  percentComplete: Scalars['PercentComplete']['output'];
