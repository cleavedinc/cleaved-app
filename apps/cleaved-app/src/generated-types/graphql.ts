...
export type Query = {
  ...
  organizationGetMembership: Array<PrivateOrganizationView>;
...
export type OrganizationGetMembershipQueryVariables = Exact<{ [key: string]: never; }>;


export type OrganizationGetMembershipQuery = { __typename?: 'Query', organizationGetMembership: Array<{ __typename?: 'PrivateOrganizationView', id: string, name?: string | null, userPermissionInOrg?: OrgPermissionLevel | null }> };
