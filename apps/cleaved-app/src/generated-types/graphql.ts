...
export type Mutation = {
  ...
  joinOrganizationWithShareLink: Scalars['ID'];
...
export type JoinOrganizationWithShareLinkMutation = { __typename?: 'Mutation', joinOrganizationWithShareLink: string };
...
export type OrganizationSeekMembersQuery = { __typename?: 'Query', organizationSeekMembers: Array<{ __typename?: 'AccountMemberView', id: string, firstName?: string | null, lastName?: string | null, currentAvatar?: string | null, jobTitle?: string | null, permissionInOrg: OrgPermissionLevel, emailAddress: string }> };
