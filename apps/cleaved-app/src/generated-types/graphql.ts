...
export type OrganizationMembershipsQuery = { __typename?: 'Query', organizationMemberships: Array<{ __typename?: 'PrivateOrganizationView', id: string, name?: string | null, userPermissionInOrg?: OrgPermissionLevel | null, projectCount: number, activeProjectCount: number, billingTier: BillingTier }> };
