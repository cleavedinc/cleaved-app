...
export type AdminOnlyOrganizationMembershipsQueryVariables = Exact<{ [key: string]: never; }>;


export type AdminOnlyOrganizationMembershipsQuery = { __typename?: 'Query', organizationMemberships: Array<{ __typename?: 'PrivateOrganizationView', id: string, name?: string | null, userPermissionInOrg?: OrgPermissionLevel | null, projectCount: number, activeProjectCount: number, billingTier: BillingTier }> };
