...
export type PostProjectSeekQuery = { __typename?: 'Query', postProjectSeek: Array<{ __typename?: 'ProjectPost', id: string, body: string, accountId: string, date: any, reactionTotalCount: string, reactionsExpressed: Array<PostReactionType>, myReaction: PostReactionType, repliesCount: string, images: Array<any>, account: { __typename?: 'AccountPublicView', id: string, firstName?: string | null, lastName?: string | null, currentAvatar?: string | null, professionals: Array<{ __typename?: 'ProfessionalUnlinkedView', id: string, jobTitle: string }> }, project: { __typename?: 'Project', id: string, name: string } }> };
...
export type ProjectByIdQuery = { __typename?: 'Query', projectById: { __typename?: 'Project', id: string, name: string, totalRootPostCount: number, totalResponseCount: number } };
...
export type ProjectsInOrgSeekQuery = { __typename?: 'Query', projectsInOrgSeek: Array<{ __typename?: 'Project', id: string, name: string, status: ProjectStatus, totalRootPostCount: number }> };
...
export const ProjectStartDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"projectStart"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"projectName"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"projectId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"projectStart"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"projectName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"projectName"}}},{"kind":"Argument","name":{"kind":"Name","value":"organizationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}}},{"kind":"Argument","name":{"kind":"Name","value":"projectId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"projectId"}}}]}]}}]} as unknown as DocumentNode<ProjectStartMutation, ProjectStartMutationVariables>;
