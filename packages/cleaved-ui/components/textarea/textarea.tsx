...
export const Textarea: FunctionComponent<TextareaProps> = (props) => {
  const { backgroundColor, className, hasBorder, minHeight, onKeyPress, onKeyUp, ...rest } = props;
  ...
  return (
    <TextareaWrapper
      ...
      minHeight={minHeight}
    >
      <textarea {...rest} onKeyDown={onKeyPress} onKeyUp={onKeyUp} ref={textAreaRef} rows={1} />
    </TextareaWrapper>
  );
};
